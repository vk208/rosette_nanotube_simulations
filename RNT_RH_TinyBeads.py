...
# the number of atoms in 1 G^C motif in a rosette ring is always 26 for the stacked ring conformation 
n_motif_atoms = 26 
...
# tiny bead 1 = TN0 
for i,b in enumerate(zip(atomtypes["C4"],atomtypes["N1"],atomtypes["C8"])):
    if i !=0: 
        j = i+counter*i+1
...
# tiny bead 2 = TP2 
for i,b in enumerate(zip(atomtypes["O2"],atomtypes["C5"],atomtypes["N2"])):
    if i !=0: 
        j = i+counter*i+2
...
# tiny bead 3 = TP1 
for i,b in enumerate(zip(atomtypes["C6"],atomtypes["N4"],atomtypes["C3"])):
    if i !=0: 
        j = i+counter*i+3
...
# tiny bead 4 = TP2
for i,b in enumerate(zip(atomtypes["O1"],atomtypes["C2"],atomtypes["N3"])):
    if i !=0: 
        j = i+ counter*i + 4
...
# tiny bead 5 = TP1 
for i,b in enumerate(zip(atomtypes["N5"],atomtypes["C1"],atomtypes["N6"])):
    if i !=0: 
        j = i+counter*i+5
...
# path to your file 
## be sure to remove the first couple of lines manually! 
path = ''
